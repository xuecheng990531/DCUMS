    ...
    for r in range(nb_experiments):
        ...
        for i in range(nb_active_learning_iter):
            ...
            if model_name == 'attentionunet':
                model_path = f'pth/DCUMS/keviar-seg/attentionunet/tau0/{model_name}_iter_{i}.pth'
                data_type = 'uncertain'
            else:
                model_path = f'pth/DCUMS/keviar-seg/unet/tau0/{model_name}_iter_{i}.pth'
                data_type = 'uncertain'
            ...
            if i == 0:
                ...
                # 加载上一轮的最佳模型
                prev_round_model_path = f'pth/DCUMS/keviar-seg/{model_name.lower()}/tau0/{model_name}_iter_{i-1}.pth'
